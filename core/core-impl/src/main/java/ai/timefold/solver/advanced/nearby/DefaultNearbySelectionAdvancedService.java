package ai.timefold.solver.advanced.nearby;

import java.util.Optional;

import ai.timefold.solver.advanced.nearby.common.NearbyRandom;
import ai.timefold.solver.advanced.nearby.common.NearbyRandomFactory;
import ai.timefold.solver.advanced.nearby.entity.NearEntityNearbyEntitySelector;
import ai.timefold.solver.advanced.nearby.list.NearSubListNearbyDestinationSelector;
import ai.timefold.solver.advanced.nearby.list.NearSubListNearbySubListSelector;
import ai.timefold.solver.advanced.nearby.list.NearValueNearbyDestinationSelector;
import ai.timefold.solver.advanced.nearby.value.NearEntityNearbyValueSelector;
import ai.timefold.solver.advanced.nearby.value.NearValueNearbyValueSelector;
...
public final class DefaultNearbySelectionAdvancedService implements NearbySelectionAdvancedService {
    @Override
