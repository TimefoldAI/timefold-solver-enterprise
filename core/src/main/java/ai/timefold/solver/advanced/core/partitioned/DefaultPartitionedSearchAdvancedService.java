...
public final class DefaultPartitionedSearchAdvancedService implements PartitionedSearchAdvancedService {

    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultPartitionedSearchAdvancedService.class);
