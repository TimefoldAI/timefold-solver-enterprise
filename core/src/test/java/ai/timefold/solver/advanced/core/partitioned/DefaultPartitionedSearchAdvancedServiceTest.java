package ai.timefold.solver.advanced.core.partitioned;

import static org.assertj.core.api.Assertions.assertThat;
import static org.mockito.Mockito.mock;
import static org.mockito.Mockito.when;

import ai.timefold.solver.advanced.core.partitioned.testdata.TestdataSolutionPartitioner;
...
class DefaultPartitionedSearchAdvancedServiceTest {
    ...
    void resolvedActiveThreadCountAuto(int availableCpuCount, int expectedResolvedCpuCount) {
        assertThat(DefaultPartitionedSearchAdvancedService.resolveActiveThreadCount(
    ...
    void resolveActiveThreadCountUnlimited() {
        assertThat(DefaultPartitionedSearchAdvancedService
