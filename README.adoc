...
NOTE: Please note that the next version of Timefold Solver Enterprise Edition will not require any authentication and thus, the entire configuration procedure is going to be more straightforward.
